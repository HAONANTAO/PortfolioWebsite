...
const EmailSection = () => {
  ...
  return (
    <section className="relative grid gap-4 py-24 my-12 md:grid-cols-2 md:my-12">
      <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1 -translate-y-1/2"></div>
      ...
      <div>
        <form className="flex flex-col" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-primary-500 hover:bg-purple-700 text-white font-medium py-2.5 px-5 rounded-lg w-full">
            Send Message
          </button>
          {emailSubmitted && (
            <p className="mt-2 text-sm text-green-500">
              EmailSend Successfully!
            </p>
          )}
        </form>
      </div>
