    ...
    <section className="grid gap-4 py-24 my-12 md:grid-cols-2 md:my-12">
      ...
      <div>
        <form className="flex flex-col gap-4">
          <label type="email" className="block mb-2 text-sm font-medium text-white" htmlFor="email">
            Your Email
          </label>
          <input type="email" id="email" required 
          className="bg-[#1819E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder="xxxx@.com"/>
        </form>
      </div>
    </section>
  );
