      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 text-center place-self-center sm:text-left ">
          ...
          <div>
            ...
            <button className="w-full px-1 py-1 mt-3 text-white rounded-full sm:w-fit bg-gradient-to-br from-blue-500 via-purple-500 to-secondary-500 hover:bg-slate-800 ">
