        ...
        <motion.div
          ...
          <div className="mb-10 space-y-4">
            <p className="text-zinc-700 dark:text-zinc-300 text-base leading-relaxed">
              ...
              I went chasing what <em>wasn&apos;t</em> familiar yet: retrieval, streaming, agents, the messy second
              half of an AI feature where the demo ends and the user shows up.
            </p>
            <p className="text-zinc-700 dark:text-zinc-300 text-base leading-relaxed">
              I picked RAG to go deep on because it&apos;s the part that decides whether an LLM product feels smart
              or stupid, and almost no one writes about it honestly. DocuMind is my running notebook on the
              topic — I rebuild the same pieces (chunking, eval sets, hybrid search) until I can say why each
              one is the size and shape it is.
            </p>
            <p className="text-zinc-700 dark:text-zinc-300 text-base leading-relaxed">
              Mostly I care about shipping. A demo I can&apos;t put in front of a real user is a research project
              with better lighting. The work I&apos;m proud of is on the App Store, on Vercel, and currently going
              live as the <strong className="font-semibold text-zinc-900 dark:text-zinc-100">internal payroll system for Shangxue Tutoring</strong> — getting
              hit by traffic from people who don&apos;t know me.
            </p>
          </div>
