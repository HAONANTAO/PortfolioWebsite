...
const EmailSection = () => {
  return (
    <section id="contact" className="relative py-28 border-t border-zinc-900/10">
      <motion.div
        ...
        <h2 className="serif text-4xl sm:text-5xl font-normal text-zinc-900 mb-4">
          Let's talk.
        </h2>

        <p className="text-zinc-600 text-base leading-relaxed mb-8 max-w-lg">
        ...
        <Link
          ...
          className="inline-block text-xl sm:text-2xl text-zinc-900 border-b border-zinc-900/30
            pb-1 transition-colors hover:text-[color:var(--accent)] hover:border-[color:var(--accent)]">
          {EMAIL}
        </Link>
